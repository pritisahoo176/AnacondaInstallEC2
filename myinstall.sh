...
cd /home/ec2-user/PythonInstance
su PythonInstance

sudo yum update -y && sudo yum install -y python36 pip

# sudo pip install --upgrade pip
sudo python3 -m pip install --upgrade pip

pip install boto3 config matplotlib numpy pandas pyarrow  sagemaker s3fs uuid tsia
